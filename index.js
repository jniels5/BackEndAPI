...
app.get('/stats/search/first', function(request,response) {
  connection.query('SELECT FirstName AS "First Name", LastName AS "Last Name", Gender, GradYear as "Expected Graduation", Email, AssetID AS "Asset ID", LabID AS "Current Lab" FROM Members WHERE FirstName = '  + request.query.Search, function (error, results, fields) {
        if(error) {
            response.json({select_status: "failed"});
        }
        else {
...
app.get('/stats/search/last', function(request,response) {
  connection.query('SELECT FirstName AS "First Name", LastName AS "Last Name", Gender, GradYear as "Expected Graduation", Email, AssetID AS "Asset ID", LabID AS "Current Lab" WHERE LastName = '  + request.query.Search, function (error, results, fields) {
        if(error) {
            response.json({select_status: "failed"});
        }
        else {
...
app.get('/stats/search/grad', function(request,response) {
  connection.query('SELECT FirstName AS "First Name", LastName AS "Last Name", Gender, GradYear as "Expected Graduation", Email, AssetID AS "Asset ID", LabID AS "Current Lab" WHERE GradYear = '  + request.query.Search, function (error, results, fields) {
        if(error) {
            response.json({select_status: "failed"});
        }
        else {
