...
('Cash Back Bonus Application', 'AR Application', 'AR app that allows users to access stores with information about the Discover Cash Back Bonus Program', 'An AR mobile application allowing users to view their favorite stores through their device in real time with information about Discover’s Cash Back Bonus program.', 'React-Native', 'NodeJS', 'DynamoDB', 19),
